...
-With the "F1" key you can activate visual fixtures and objects, and if you left click a ball you can move it wherever you want.
...
-Added ORIGINAL's game music and sound effects of the level.
...
-"Shake machine" feature(the one that makes everything tremble).
